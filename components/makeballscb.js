...
let anzPoints = 5;
let maxDiff = 3; // Easy for Cardboard; deviation from the standard path, greater = more difficult
...
AFRAME.registerComponent('makeballs', {
  ...
  init: function () {
    ...
    for(let a = 1; a <= totalBallElements; a++){
      ...
      let pathDuration = getRandomNumber(6500, 8000) - a*200; // Easy for Cardboard; smaller = faster
